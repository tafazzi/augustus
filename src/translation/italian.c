...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_GO_TO_BOOKMARK_1, "Vai a segnalibro 1"},
    {TR_HOTKEY_GO_TO_BOOKMARK_2, "Vai a segnalibro 2"},
    {TR_HOTKEY_GO_TO_BOOKMARK_3, "Vai a segnalibro 3"},
    {TR_HOTKEY_GO_TO_BOOKMARK_4, "Vai a segnalibro 4"},
    {TR_HOTKEY_SET_BOOKMARK_1, "Imposta segnalibro 1"},
    {TR_HOTKEY_SET_BOOKMARK_2, "Imposta segnalibro 2"},
    {TR_HOTKEY_SET_BOOKMARK_3, "Imposta segnalibro 3"},
    {TR_HOTKEY_SET_BOOKMARK_4, "Imposta segnalibro 4"},
