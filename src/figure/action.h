...
enum {
    ...
    FIGURE_ACTION_203_FARMER_SPAWNED = 203,
    FIGURE_ACTION_204_FARMER_GOING_TO_PLOT = 204,
    FIGURE_ACTION_205_FARMER_FARMING = 205,
    FIGURE_ACTION_206_FARMER_RETURNING_TO_FARMHOUSE = 206,
};
